...
* And (eventually) we need to support a pretty wide range of possible grids including rectilinear in lat/lon or projected coordinates, healpix, and unstructured meshes
